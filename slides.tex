...
\setbeamertemplate{footline}{%
  ...
  \hbox{%
    ...
    \begin{beamercolorbox}[wd=.34\paperwidth,ht=2.25ex,dp=1ex,center]{title in head/foot}
      \normalfont\scriptsize softmax action model
    \end{beamercolorbox}%
...
\subtitle{Tiny Softmax Transformer for Action-Sequence Chat}
\author{Dancing With My Code}
\date{Softmax rollback, 2026-05-26}
    ...
    \begin{column}{0.48\textwidth}
      \begin{block}{Input Side}
        \begin{itemize}
          ...
          \item Context length stays at 64
        \end{itemize}
      \end{block}
    \end{column}
    \begin{column}{0.48\textwidth}
...
\begin{frame}{Action Vocabulary}
  ...
  \begin{tabular}{rll@{\qquad}rll}
    ...
    \textbf{ID} & \textbf{Action} & \textbf{Role}
      & \textbf{ID} & \textbf{Action} & \textbf{Role} \\
    \midrule
     0 & Start & sequence start     & 12 & GoRust & Rust beats Go \\
     1 & End & sequence end         & 13 & RustWin & Rust wins again \\
     2 & Greeting & hello             & 14 & GoBully & roast Go \\
     3 & ReplyGreeting & hello back  & 15 & WhoMe & identity \\
     4 & Eat & food topic            & 16 & AboutCreator & about Lookhin/site \\
     5 & DailyLife & normal chat     & 17 & PissOff & clap back \\
     6 & AskBack & keep talking      & 18 & CalmDown & de-escalate \\
     7 & Joke & quick joke           & 19 & Farewell & goodbye only \\
     8 & Roast & playful insult      & 20 & Normal & neutral mood \\
     9 & Happy & happy mood          & 21 & TH & Thai \\
...
\begin{frame}{Training Loss Curve}
  ...
  \vspace{0.15cm}
  \small
  Raw CUDA training loss with 80-step smoothing from \code{runs/action-model/loss.csv}.
\end{frame}
...
\begin{frame}{Current Checkpoint}
  ...
  \begin{tabular}{lr}
    ...
    \midrule
    Checkpoint & \code{runs/action-model/final.mpk} \\
    Params & 24,192 \\
    Validation loss & 1.113533 \\
    Validation perplexity & 3.0451 \\
    Validation accuracy & \alert{63.5349\%} \\
    \bottomrule
  \end{tabular}
...
\begin{frame}{Training Path}
  ...
  \begin{block}{CUDA Training}
    ...
    \code{\quad --steps 3000 --batch-size 32 --lr 0.003}\\
    \code{\quad --checkpoint-dir runs/action-model}
  \end{block}
